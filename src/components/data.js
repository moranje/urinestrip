  ...
  local: {
    healthy: {
      antibiotics: {
        ...
        contraIndications: [
          '',
          'Contra-indicaties: eGFR < 30 ml/min',
          '',
          'Let op: Bij een eGFR 10-30 ml/min: eerste 3 dagen normale dosering. Daarna 50% van de normale dosering.',
        ],
      },
      advice:
    ...
    vulnerable: {
      ...
      docs:
        '<treatment>. Urine op kweek (behalve bij verder gezonde vrouwen met DM), graag contact over uitslag. Opnieuw controle van urine is niet nodig indien de klachten na de kuur verdwijnen. Contact bij klachten zoals beschreven op https://www.thuisarts.nl/blaasontsteking.',
    },
    pregnant: {
      antibiotics: {
        description: [
      ...
      docs:
        '<treatment>. Urine op kweek (ook om groep-B-streptokokken (GBS) uit te sluiten), graag contact over uitslag. Opnieuw controle van urine is niet nodig indien de klachten na de kuur verdwijnen. Contact bij klachten zoals beschreven op https://www.thuisarts.nl/blaasontsteking.',
    },
    cadWoman: {
      antibiotics: {
        description: [],
    ...
    men: {
      ...
      docs:
        '<treatment>. Urine op kweek, graag contact over uitslag. Opnieuw controle van urine is niet nodig indien de klachten na de kuur verdwijnen. Contact bij klachten zoals beschreven op https://www.thuisarts.nl/blaasontsteking.',
    },
    cadMen: {
      antibiotics: {
        description: [],
    ...
    children: {
      ...
      docs:
        '<treatment>. Urine op kweek bij kinderen < 12 jaar, graag contact over uitslag. Opnieuw controle van urine is niet nodig indien de klachten na de kuur verdwijnen. Contact bij klachten zoals beschreven op https://www.thuisarts.nl/blaasontsteking. Indien binnen 48 uur geen verbetering overweeg verwijzing naar kinderarts.',
    },
  },
  tissueInvasion: {
    healthy: {
      antibiotics: {
        ...
        contraIndications: [
          'Let op: Bij een eGFR 10-30 ml/min: geef de normale keerdosis met een interval van 24 uur tussen 2 doses',
          'Let op: Bij een eGFR < 30 ml/min: pas de dosering aan naar amoxicilline/clavulaanzuur 875/125 mg 2 dd',
          'Let op: bij een eGFR 10-30 ml/min: geef 50% van de normale keerdosis OF verdubbel het doseerinterval',
        ],
      },
      advice:
      ...
      docs:
        '<treatment>. Urine op kweek, graag contact over uitslag. Opnieuw controle van urine is niet nodig indien de klachten na de kuur verdwijnen. Contact indien na 48 uur geen vebetering of verergering optreedt en bij klachten zoals beschreven op https://www.thuisarts.nl/blaasontsteking.',
    },
    vulnerable: {
      antibiotics: {
        description: [
